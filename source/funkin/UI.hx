...
class UI extends FlxSpriteGroup
{
	...
	public function updateScoreText()
	{
		...
		var ranking:String = ' [${Timings.returnScoreRating()}]';
		if (Timings.comboDisplay != '' && Timings.comboDisplay != null)
			ranking = ' [${Timings.returnScoreRating()}$divider${Timings.comboDisplay}]';
